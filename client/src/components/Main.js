        ...
        text = (
            <>
                ...
                <p>
                    ...
                    Colorというページで、こちらでは、画像上のどこでもクリックした場所の色について調べることができます。(Main Color, Any Colorへは画面上のタブから進めます。）どちらのページも、選んだパレットから、調べたい色か、その色がなければ、それに一番近い色が選びだされて返ってきます。
                </p>
                <p>
                    「日本の伝統色」、「English」、「Français」の各パレットにある色の数や種類が違うのでパレットによって「一番近い色」も変わってきます。実際にパレット／言語を切り替えると、返ってくる色と名前も同じではありません。
                </p>
            </>
        );
    }
